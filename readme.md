...
## Deploying
The first time you deploy to a PaaS space it will fail because it doesn't have the envars.
To set the environment variables on PaaS, run them like this:

`cf set-env defra-next-warning-system-alert-web-sandbox ENV sandbox`
`cf set-env defra-next-warning-system-alert-web-test ENV test`
`cf set-env defra-next-warning-system-alert-web-production ENV production`

then one of

`cf restage defra-next-warning-system-alert-web-sandbox`
`cf restage defra-next-warning-system-alert-web-test`
`cf restage defra-next-warning-system-alert-web-production`
